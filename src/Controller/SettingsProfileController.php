...
class SettingsProfileController extends AbstractController
{
    ...
    public function profile(Request $request, UserRepository $usersRepo): Response
    {
        /**
         * @var User $user
         */
    ...
    #[Route('/settings/profile/profile_image', name: 'app_settingsprofile_profileimage')]
    #[IsGranted("IS_AUTHENTICATED_FULLY")]
    public function profileImage(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($profileImageFile) {
                ...
                return $this->redirectToRoute('app_settingsprofile_profileimage');
            }
        }
